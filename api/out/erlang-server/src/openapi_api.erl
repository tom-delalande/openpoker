...
validate_response('Tables_connect', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('Tables_connect', 0, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('Tournaments_create', 200, Body, ValidatorState) ->
    validate_response_body('Tournament', 'Tournament', Body, ValidatorState);
validate_response('Tournaments_create', 0, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('Tournaments_delete', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('Tournaments_delete', 0, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('Tournaments_join', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('Tournaments_join', 0, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('Tournaments_leave', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('Tournaments_leave', 0, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('Tournaments_list', 200, Body, ValidatorState) ->
    validate_response_body('list', 'Tournament', Body, ValidatorState);
validate_response('Tournaments_list', 0, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('Tournaments_start', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('Tournaments_start', 0, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('Tournaments_status', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('Tournaments_status', 0, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
...
request_params('Tables_connect') ->
    [
        'id'
    ];
request_params('Tournaments_create') ->
    [
        'Tournament'
    ];
request_params('Tournaments_delete') ->
    [
        'id'
    ];
request_params('Tournaments_join') ->
    [
        'id'
    ];
request_params('Tournaments_leave') ->
    [
        'id'
    ];
request_params('Tournaments_list') ->
    [
    ];
request_params('Tournaments_start') ->
    [
        'id'
    ];
request_params('Tournaments_status') ->
    [
        'id'
    ];
request_params(_) ->
...
request_param_info('Tables_connect', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('Tournaments_create', 'Tournament') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/Tournament">>},
            required
        ]
    };
request_param_info('Tournaments_delete', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('Tournaments_join', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('Tournaments_leave', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('Tournaments_start', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('Tournaments_status', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
